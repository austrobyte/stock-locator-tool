...
var StockLocatorTool = function (_a) {
    ...
    return (react_1.default.createElement(StyledStockLocatorTool, { style: { fontFamily: "".concat(font), backgroundColor: "".concat(theme.background) } },
        !searchParameters.disableSearch && (react_1.default.createElement(searchForm_1.default, { query: query, setQuery: setQuery, country: country, setCountry: setCountry, currency: currency, setCurrency: setCurrency, handleFormSubmit: handleFormSubmit, theme: theme })),
        ...
        !hasResults && (react_1.default.createElement(NoResultsFound_1.default, { query: lastSearch, response: response, theme: theme, searchParameters: searchParameters })),
