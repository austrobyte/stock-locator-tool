...
var NoResultsFound = function (_a) {
    var query = _a.query, response = _a.response, theme = _a.theme, searchParameters = _a.searchParameters;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        !searchParameters.disableSearch && (react_1.default.createElement(searchResults_1.ResultsHeader, null,
